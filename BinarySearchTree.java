...
public class BinarySearchTree {
    ...
    private TreeNode root; //This variable holds the reference to the root node of the binary search tree.
     ...
     */
    public void output(){
        // In-order traversal to print the contents of the tree in ascending order
    ...
    public void remove(int value){
		...
		*/
        ...
        if (nodeToRemove.leftChild == null && nodeToRemove.rightChild == null) {
            ...
            TreeNode largestLeft = findLargest(nodeToRemove.leftChild);
            nodeToRemove.data = largestLeft.data;
            replaceNode(largestLeft, largestLeft.leftChild);
        }
    }
